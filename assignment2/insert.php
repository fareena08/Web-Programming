...
if (isset($_POST['add_form'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("INSERT INTO myguestbook2(user, email, howfindme, frontpage, form, ui, postdate, posttime, comment) VALUES (:user, :email, :howfindme, :frontpage, :form, :ui, :pdate, :ptime, :comment)");
 ...
 <body><p><a href="index.php">Home</a></a></p>
